...
$s_id = $_GET['id'];
$sql = "SELECT * FROM irevssa WHERE id={$s_id}";
...
<body>
    <div class="container mt-5">
        ...
        ?>
        <form class="card p-4 shadow-sm" action="updateirevsa.php" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="sname" name="details" value="<?php echo $row['details']; ?>" required/>
