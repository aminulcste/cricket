                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result_test) > 0) {
                                    while ($row = mysqli_fetch_assoc($result_test)) {
                                        ...
                                        echo "<td>" . $row['test'] . "</td>";
                                        echo "<td>
                                                <a href='update_rank.php?id=" . $row['id'] . "' class='btn btn-warning btn-sm'>Update</a>
                                                <a href='delete_rank.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this?\");'>Delete</a>
                                              </td>";
                                        echo "</tr>";
                                    }
                                } else {
